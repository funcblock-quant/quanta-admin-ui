    ...
    <template #wrapper>
      ...
      <el-card class="box-card">
        <el-descriptions v-loading="loading" title="Observer参数" :column="3">
          ...
          <el-descriptions-item label="Profit Trigger Rate">
            <template v-if="!isObserverEdit">
          ...
          <el-descriptions-item label="Ask Depth">
            {{ busDexCexTriangularObserver.askDepth }}
          </el-descriptions-item>
          <el-descriptions-item label="Bid Depth">
            {{ busDexCexTriangularObserver.bidDepth }}
          </el-descriptions-item>
      ...
      <el-card v-if="busDexCexTriangularObserver.status === '3' && busDexCexTriangularObserver.isTrading" class="box-card">
        <el-descriptions v-loading="loading" title="Trader参数" :column="3">
          ...
          <el-descriptions-item label="Jito Fee Rate">
            ...
            <el-input v-else v-model="traderRequestParams.jitoFeeRate" size="mini" @input="handleSlippageInput" />
          </el-descriptions-item>
        </el-descriptions>
      ...
      <el-card v-if="busDexCexTriangularObserver.status === '2' || busDexCexTriangularObserver.status === '3'" class="box-card">
        <el-descriptions v-loading="loading" title="水位调节参数" :column="3">
          ...
          <el-descriptions-item label="最低预警余额(U)">
          ...
          <el-descriptions-item label="低水位触发余额(U)">
            <template v-if="!isWaterLevelEdit">
          ...
          <el-descriptions-item label="高水位触发余额(U)">
            <template v-if="!isWaterLevelEdit">
          ...
          <el-descriptions-item label="最低充值金额阈值(U)">
            <template v-if="!isWaterLevelEdit">
          ...
          <el-descriptions-item label="最低提现金额阈值(U)">
            <template v-if="!isWaterLevelEdit">
