    ...
    <template #wrapper>
      <el-card class="box-card">
        <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
          <el-form-item label="交易所账户组" prop="groupName"><el-input
        ...
        <el-table v-loading="loading" :data="busExchangeAccountGroupList" @selection-change="handleSelectionChange">
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px">
          <el-form ref="form" :model="form" :rules="rules" label-width="80px">
            ...
            <el-form-item label="交易所账户组" prop="groupName">
              <el-input
...
export default {
  ...
  data() {
    return {
      ...
      // 表单校验
      rules: { groupName: [{ required: true, message: '交易所账户组不能为空', trigger: 'blur' }]
      }
    }
  },
  created() {
        ...
        if (valid) {
          ...
          this.$confirm('确定提交修改吗?', '提示', {
            ...
            if (this.form.id !== undefined) {
              updateBusExchangeAccountGroup(this.form).then(response => {
              ...
              addBusExchangeAccountGroup(this.form).then(response => {
                if (response.code === 200) {
                  this.msgSuccess(response.msg)
                  this.open = false
                  this.getList()
