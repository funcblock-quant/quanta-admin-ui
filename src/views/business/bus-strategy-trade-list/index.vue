  ...
  <BasicLayout>
    <template #wrapper>
      <el-card class="box-card">
        ...
        <el-table v-loading="loading" :data="busStrategyTradeListList" @selection-change="handleSelectionChange">
  ...
  methods: {
    ...
    getList() {
      ...
      listBusStrategyTradeList(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
        this.busStrategyTradeListList = response.data.list
